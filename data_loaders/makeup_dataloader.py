...
class MakeupDataloader(Dataset):
    ...
    def __getitem__(self, index):
        ...
        mask_s,mask_dischange_eye_mouth_s, mask_dischange_bachground_s = self.preprocess.process(mask_s.unsqueeze(0))
        mask_r,mask_dischange_eye_mouth_r, mask_dischange_bachground_r = self.preprocess.process(mask_r.unsqueeze(0))

        return [image_s, mask_s,lm_s,mask_dischange_eye_mouth_s, mask_dischange_bachground_s], [image_r, mask_r,lm_r,mask_dischange_eye_mouth_r, mask_dischange_bachground_r]
