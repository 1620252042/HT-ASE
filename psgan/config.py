...
_C.TRAINING = CfgNode()
_C.TRAINING.G_LR = 1e-4
_C.TRAINING.D_LR = 1e-4
...
_C.TRAINING.NUM_EPOCHS_DECAY = 40
...
_C.PREPROCESS.FACE_CLASS = [1, 6,2,3]
_C.PREPROCESS.NECK_AND_EAR_CLASS=[11,12,13]
